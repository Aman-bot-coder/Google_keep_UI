...
// import 'package:google_keep/Activity/com.tekartik.sqflite.SqflitePlugin';
...
class _HomeState extends State<Home> {
  ...
  Future createEntry() async {
    await NotesDb.instance.InsertEntry();
  }

  Future<String?> getAllNotes() async{
    await NotesDb.instance.readAllNotes();
  }
  Future<String?> getOneNotes() async{
    await NotesDb.instance.readOneNote(1);
  }
